...
export const COLUMN_DEFINITIONS = addColumnSortLabels([
  {
    id: 'DeviceName',
    cell: (item) => (
      <Link href={`/my-minipuppers/${item.DeviceId}`}>{item.DeviceName}</Link>
    ),
    header: 'Device Name',
    minWidth: 120,
    maxWidth: 200,
...
export const PAGE_SIZE_OPTIONS = [
  { value: 10, label: '10 MiniPuppers' },
  { value: 30, label: '30 MiniPuppers' },
  { value: 50, label: '50 MiniPuppers' },
];
...
export const VISIBLE_CONTENT_OPTIONS = [
  {
    label: 'Main My MiniPuppers Table properties',
    options: [
