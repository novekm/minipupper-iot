...
import { COLUMN_DEFINITIONS } from './MyMiniPuppersTable/table-property-filter-config';

import MyMiniPuppersTable from './MyMiniPuppersTable';
...
const MyMiniPuppers = () => {
  ...
  return (
    <AppLayout
      navigation={<Sidebar activeHref="/my-minipuppers" />}
...
export const FullPageHeader = ({
  resourceName = 'MiniPuppers',
  createButtonText = 'Add MiniPupper',
  ...props
}) => {
...
export const ToolsContent = () => (
  ...
  >
    <p>
      ...
      an individual MiniPupper.
    </p>
  </HelpPanel>
);

export const MyMiniPuppersTableEmptyState = ({ resourceName }) => {
  const navigate = useNavigate();
