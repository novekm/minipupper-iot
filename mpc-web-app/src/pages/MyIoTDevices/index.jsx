...
import { COLUMN_DEFINITIONS } from './IoTDevicesTable/table-property-filter-config';
...
export const FullPageHeader = ({
  resourceName = 'IoT Devices',
  createButtonText = 'Add IoT Device',
  ...props
}) => {
...
export const ToolsContent = () => (
  ...
  >
    <p>
      View your current current IoT Devices and relevant device information. To drill
      down even further into the details and issue commands, select the name of
      an individual IoT Device.
    </p>
  </HelpPanel>
);

export const MyIoTDevicesTableEmptyState = ({ resourceName }) => {
  const navigate = useNavigate();
      ...
      <SpaceBetween size="xxs">
        <div>
          ...
          <Box variant="p" color="inherit">
            No {resourceName}s found. Click 'Create {resourceName}' to add an IoT Device.
          </Box>
        </div>
