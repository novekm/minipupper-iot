...
import { COLUMN_DEFINITIONS } from './MICDDevicesTable/table-property-filter-config';

import MICDDevicesTable from './MICDDevicesTable';
...
export const FullPageHeader = ({
  resourceName = 'MICD Devices',
  createButtonText = 'Add MICD Device',
  ...props
}) => {
...
export const ToolsContent = () => (
  ...
  >
    <p>
      View your current current MICD Devices and relevant device information. To drill
      down even further into the details and issue commands, select the name of
      an individual MICD Device.
    </p>
  </HelpPanel>
);

export const MyMICDDevicesTableEmptyState = ({ resourceName }) => {
  const navigate = useNavigate();
