...
import { MICDDeviceMetricsTableConfig,} from './config'
...
const Content = ({ user, isInProgress }) => {
  ...
  // Fetch all MICDDevices in the MICD DynamoDB Metadata Table
  const fetchMICDDevices = async () => {
    try {
      ...
      console.log('MICD Device List', MICDDeviceDataList);
  ...
  return (
    <>
      ...
      <Overview micdDevices={micdDevices} />
