...
import MICDDevices from './MyMICDDevices';
import SingleMICDDevice from './SingleMICDDevice';
  ...
  return (
    <>
      ...
      <Routes>
        ...
        <Route path="/micd-devices/" element={<MICDDevices />} />
        <Route path="/micd-devices/:DeviceId" element={<SingleMICDDevice />} />
